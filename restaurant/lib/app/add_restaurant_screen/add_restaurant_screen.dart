        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                Visibility(
                  visible: controller.userModel.value.subscriptionPlan?.features?.qrCodeGenerate != false,
                  child: Padding(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFieldWidget(
                            title: 'Charges per ${Constant.distanceType} (distance)'.tr,
                          ...
                          TextFieldWidget(
                            title: 'Min Delivery Charges within ${Constant.distanceType} (distance)'.tr,
                            controller: controller.minDeliveryChargesWithinKMController.value,
                            hintText: 'Enter Min Delivery Charges within ${Constant.distanceType} (distance)'.tr,
                            enable: controller.isEnableDeliverySettings.value,
                            textInputType: const TextInputType.numberWithOptions(signed: true, decimal: true),
                            textInputAction: TextInputAction.done,
                            inputFormatters: [
